...
# 删除已有测试cmd脚本
path = "D:\\git\\monkeyTest\\Monkey_performance"
...
if aw == 'y':
    ...
    for i in range(n):
        ...
        path_log = "D:\\git\\monkeyTest\\Monkey_performance" + name + '-' + model
        if app_name == 'com.quvideo.slideplus':
            ...
            w_adb.write(
                'adb -s ' + dev + ' shell monkey -p ' + app_name + ' -s 200 --throttle 500 --ignore-crashes --ignore-timeouts --pct-touch 45 --pct-trackball 15 --pct-appswitch 10 --pct-syskeys 10 --pct-motion 20 -v -v 210000 > ')  # 选择设备执行monkey
